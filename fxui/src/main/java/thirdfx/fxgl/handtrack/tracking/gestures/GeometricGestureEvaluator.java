package thirdfx.fxgl.handtrack.tracking.gestures;

import com.almasb.fxgl.logging.Logger;
import javafx.geometry.Point3D;
import javafx.util.Pair;
import thirdfx.fxgl.handtrack.tracking.*;

import java.util.EnumMap;
import java.util.function.BiFunction;
import java.util.stream.Collectors;

import static thirdfx.fxgl.handtrack.tracking.HandGesture.*;
import static thirdfx.fxgl.handtrack.tracking.HandLandmark.*;
